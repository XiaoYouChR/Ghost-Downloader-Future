...
import type {DesktopConnectionState, DesktopRequestResult, TaskSummary,} from "../shared/types";
...
let cachedInstallType = "";

export function setInstallType(type: string) {
